...
class NetworkUtility:
    ...
    def count_usable_address(self, ip_network, mask : int): 
        pangkat = 32 - mask
        usable_address = 1
    ...
    def get_broadcast_address_byslash(self, ip_address, mask : int):
        ## CONVERTS SUBNET TO BINARY
        bin_mask = self.get_binary_mask(mask)
    ...
    def get_network_address(self, ip_address, subnet_mask):
        ...
        ## REPLACE LAST N(SUBNET ZERO COUNT) DIGIT TO 0
        bin_list = list(bin_ip_addr)
    ...
    def get_network_address_byslash(self, ip_address, mask : int):
        ## CONVERTS SUBNET VALUE TO BINARY
        bin_mask = self.get_binary_mask(mask)
    ...
    def isSubnetValid(self, subnet_mask):
